          ...
          <div className="panel panel-default">
            ...
            <div id="collapseOne" classNameName="panel-collapse collapse in">
              <div className="panel-body">
                ...
                <ol>
                  <li>
                    <a href="http://www.gutenberg.org/" target="_blank">
          ...
          <div className="panel panel-default">
            ...
            <div id="collapseTen" className="panel-collapse collapse">
              <div className="panel-body">
                ...
                <ol>
                  <li>
                    <a href="http://www.greatachievements.org/" target="_blank">
                      {" "}
          ...
          <div className="panel panel-default">
            ...
            <div id="collapseEleven" className="panel-collapse collapse">
              <div className="panel-body">
                ...
                <ol>
                  <li>
                    <a href="http://www.pfc.org.in/db/db.htm" target="_blank">
                      Indian Patent Searchable Database
                    </a>
                  </li>{" "}
                  <hr className="line" />
                  <li>
                    <a href="http://patinfo.nic.in" target="_blank">
                      Govt India Patent Website{" "}
                    </a>
                  </li>{" "}
                  <hr className="line" />
                  <li>
                    <a href="http://www.nipo.in/" target="_blank">
            ...
            <div id="collapseFour" className="panel-collapse collapse">
              <div className="panel-body">
                ...
                <ol>
                  ...
                  <hr className="line" />
                  <li>
                    <a href="http://www.britannica.coms" target="_blank">
            ...
            <div id="collapsesix" className="panel-collapse collapse">
              <div className="panel-body">
                ...
                <ol class="jouls">
                  ...
                  <li>
                    <a href="http://www.academics-india.com/" target="_blank">
